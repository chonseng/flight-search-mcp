...
from flight_scraper.core.models import SearchCriteria, TripType, FlightOffer, FlightSegment, ScrapingResult, ScrapingError
...
class TestGoogleFlightsScraper:
    ...
    async def test_context_manager_success(self):
        ...
        with patch.object(self.scraper, 'initialize') as mock_init, \
    ...
    async def test_initialize_success(self):
        ...
        with patch('flight_scraper.core.scraper.BrowserManager') as MockBrowserManager, \
    ...
    async def test_scrape_flights_success(self):
        ...
        with patch.object(self.scraper, '_record_session_health') as mock_record_health:
            ...
            mock_form_handler.navigate_to_google_flights.assert_called_once_with(self.sample_criteria)

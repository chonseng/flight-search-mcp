...
from .models import SearchCriteria, TripType, ScrapingError, NavigationError, ElementNotFoundError
from ..utils import (
    random_delay, robust_fill, robust_click, format_date_for_input
)
...
class FormHandler:
    ...
    async def navigate_to_google_flights(self, criteria: SearchCriteria) -> None:
        ...
        try:
            ...
            url = (GOOGLE_FLIGHTS_URLS["round_trip"] 
            ...
            try:
                ...
                raise NavigationError(f"Navigation failed with both primary and fallback URLs: {str(e)}")
